...
from mambaBase import Mamba, ModelArgs
...
class CNN3D(nn.Module):
    def __init__(self, t_dim=120, img_x=90, img_y=120, drop_p=0.2, fc_hidden1=256, fc_hidden2=128, num_classes=50):
        ...
        self.ft_fc=nn.Sequential(
            nn.Linear(self.conv2_outshape[1] * self.conv2_outshape[2], 128),
        ...
        self.mamba_model = Mamba(modelArg)
        self.classifier=nn.Sequential(
            nn.Linear(self.ch2 * self.conv2_outshape[0]*128, 128),
            nn.ReLU(inplace=True),
