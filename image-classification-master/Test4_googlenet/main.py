...
def train(train_loader,test_loader,args):
    device=torch.device(args.device)
    # create model
    model =GoogLeNet(num_classes=args.num_classes, aux_logits=False, init_weights=True)
    model.to(device)
...
if __name__ == '__main__':
    ...
    print(mean_results)
    np.save('/home/yjzhang/code/Fujian_Video/results/image_googlenet_4frame_128.npy', results_all_seed)
