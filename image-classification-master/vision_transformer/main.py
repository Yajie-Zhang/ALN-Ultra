...
from vit_model import create_vit_base as create_model
...
def train(train_loader,test_loader,args):
    device=torch.device(args.device)
    # create model
    model =create_model(img_size=args.img_size, num_classes=args.num_classes)
    model.to(device)
...
if __name__ == '__main__':
    ...
    print(mean_results)
    np.save('/home/yjzhang/code/Fujian_Video/results/image_vit_1frame_128.npy', results_all_seed)
