...
def train(train_loader,test_loader,args):
    device=torch.device(args.device)
    # create model
    model = AlexNet(num_classes=args.num_classes, init_weights=False)
    model.to(device)
...
if __name__ == '__main__':
    ...
    print(mean_results)
    np.save('/home/yjzhang/code/Fujian_Video/results/image_alexnet_1frame_128.npy', results_all_seed)
